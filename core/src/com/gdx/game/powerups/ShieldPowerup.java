...
public class ShieldPowerup extends Powerup implements Collidable {

    public ShieldPowerup(float locationInX, float locationInY, float width, float height, Texture texture) {
